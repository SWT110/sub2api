export default {
    ...
    users: {
      ...
      platformQuota: {
        ...
        weeklyStartAt: 'Weekly window start (optional)',
        weeklyStartAtHint: 'Interpreted in the browser time zone. Leave it empty when resetting to use the reset time; “Adjust start only” preserves weekly usage.',
        weeklyStartAtInvalid: 'Enter a valid weekly window start time',
        adjustWeeklyStart: {
          button: 'Adjust start only',
          title: 'Change only the weekly window start and preserve weekly usage',
          required: 'Enter a weekly window start time first',
          future: 'The weekly window start cannot be in the future',
          expired: 'The weekly window start must be within the last 7 days or the quota would already be expired',
          confirm: 'Adjust only the weekly window start for {platform}? Existing weekly usage will be preserved.',
          success: 'Updated the {platform} weekly window start and preserved usage',
          failed: 'Failed to update the weekly window start',
        },
      },
      weeklyQuotaSync: {
        toolbar: 'Weekly Quota Sync',
        title: 'OpenAI Weekly Quota Sync',
        enabled: 'Automatic sync',
        sourceAccount: 'Source account',
        sourcePlaceholder: 'Select an OpenAI OAuth account',
        sourceHint: 'Only non-shadow OpenAI OAuth accounts are shown; inactive accounts cannot be enabled.',
        pollInterval: 'Check interval (seconds)',
        pollIntervalHint: 'Allowed range: 60 - 3600 seconds',
        invalidPollInterval: 'The check interval must be an integer between 60 and 3600 seconds',
        sourceRequired: 'Select a source account before enabling automatic sync',
        status: 'Sync status',
        observedResetAt: 'Last observed upstream next reset',
        observedWeeklyUsedPercent: 'Last observed upstream 7-day usage',
        peakWeeklyUsedPercent: 'Current-cycle upstream usage peak',
        pendingSignal: 'Window start awaiting authoritative reset-time calibration',
        pendingResetAt: 'Upstream next reset awaiting authoritative time calibration',
        signalResetTime: 'Upstream next-reset time changed',
        signalUsagePercent: 'Upstream 7-day usage reached zero',
        signalUsagePercentDrop: 'Upstream 7-day usage dropped sharply',
        signalWindowStartCalibration: 'Authoritative reset time calibrated the window start',
        windowStart: 'Last synchronized window start',
        lastCheckedAt: 'Last check',
        lastTriggeredAt: 'Last automatic reset',
        lastTriggerSignal: 'Last automatic reset signal',
        pendingSourceAccountRecovery: 'Source account recovery pending',
        pendingSourceAccountRecoveryHint: 'The previous automatic recovery did not complete. The system will retry without resetting user quotas again.',
        lastSourceAccountRecoveredAt: 'Last automatic source-account recovery',
        lastAffectedUsers: 'Users affected last time',
        lastError: 'Last error',
        notAvailable: '-',
        checkNow: 'Check now',
        checking: 'Checking...',
        checkRequiresSavedSource: 'Save the selected source account before checking',
        checkBaseline: 'The current upstream weekly quota state was recorded as the baseline',
        checkPending: 'Waiting for the authoritative reset time to calibrate the window start',
        checkReset: 'An upstream reset was detected; {count} users were synchronized',
        checkResetAndRecovered: 'An upstream reset was detected; {count} users were synchronized and the source account was recovered',
        checkSourceAccountRecovered: 'The source account rate-limit state was recovered',
        checkWindowStartAligned: 'The weekly window start was calibrated for {count} users; usage was preserved',
        checkComplete: 'Check completed; no new upstream reset was detected',
        manualAnchor: 'Manual bulk anchor',
        manualAnchorTime: 'Window start',
        resetAll: 'Reset all user weekly quotas',
        resetting: 'Resetting...',
        resetConfirm: 'Reset every configured OpenAI weekly quota at this time?',
        resetSuccess: 'Reset weekly quotas for {count} users',
        invalidAnchorTime: 'Enter a valid window start time',
        futureAnchorTime: 'The window start time cannot be in the future',
        save: 'Save configuration',
        saving: 'Saving...',
        saveSuccess: 'Weekly quota sync configuration saved',
        loadFailed: 'Failed to load weekly quota sync configuration',
        saveFailed: 'Failed to save weekly quota sync configuration',
        checkFailed: 'Failed to check the upstream weekly quota state',
        resetFailed: 'Failed to reset user weekly quotas',
      }
    },
