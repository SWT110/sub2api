export default {
    ...
    users: {
      ...
      weeklyQuotaSync: {
        ...
        pendingSignal: 'Sync signal awaiting confirmation',
        pendingResetAt: 'Upstream next reset awaiting confirmation',
        ...
        checkPending: 'A possible upstream reset was found; it will sync after the next check confirms it',
