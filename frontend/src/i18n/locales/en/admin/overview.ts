export default {
    ...
    users: {
      ...
      weeklyQuotaSync: {
        ...
        checkBaseline: 'The current upstream reset time was recorded as the baseline',
        checkPending: 'A new upstream window was found; it will sync after the next check confirms it',
        ...
        checkFailed: 'Failed to check the upstream reset time',
